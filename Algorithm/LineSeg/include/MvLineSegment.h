...
public:
	...
	//快速的burns线段提取算法
	void quickBurnsLineExtraction(Ipp8u* pixels, int step, int width, int height, int nDirections, 
			int min_gradient, float min_length, LSDLine** line, int* num_lines,int nFx);
};
