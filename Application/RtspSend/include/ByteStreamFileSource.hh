...
typedef std::list<std::string> RtspListFrame;
#include<time.h>
...
//operation about List
int getSource(/*unsigned char *sourceBuffer, int length*/);
void addRtspListFrame(unsigned char *srcBuffer, int length,  int*nalArray, int nalNum, int64_t end_encode_time);
void PopRtspListFrame(std::string& RtspFrame);
RtspListFrame m_RtspListFrame;
